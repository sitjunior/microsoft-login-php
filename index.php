...
$client_id = "bd036df8-ae38-490e-b1dc-278c17c25db5";
$client_secret = "koz8Q~7P1SMzTnjb.zKzjdXwBRZcyaArTH33ZcK5";
$app_url = "https://tenfen.dev/teste2/";
...
$auth_code_url = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize";
$token_grant_url = "https://login.microsoftonline.com/common/oauth2/v2.0/token";
...
if ($action == 'login'){
    ...
    echo '<script>window.location.href = "'.$auth_code_url.'?'.http_build_query($params).'";</script>';
    exit;
}
...
if (isset($_POST['code']) && $_POST['state'] == session_id()){
    ...
    if (isset($access_token_response['access_token'])){
        ...
        echo '<script>window.location.href = "https://tenfen.dev/teste2/";</script>';
        exit;
    }
    else{
...
if ($action == 'logout'){
    ...
    header ('Location: https://tenfen.dev/teste2/');
}